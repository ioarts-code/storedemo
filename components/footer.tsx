...
function DivAbsolute2() {
  return (
    <div className="absolute content-stretch flex flex-col items-end right-[44px] mobile:right-[16px] mobile:bottom-[16px] tablet:top-[472px] mobile:w-auto" data-name="div.absolute">
