export default function HeroSection() {
  return (
    <aside className="w-[624px] bg-[#0f0f0f] px-[24px] py-[190px] h-[1282px]">
      <h1 className="font-['Inter:Bold',sans-serif] font-bold text-[#f5f5f5] tracking-[-0.24px] uppercase leading-[36px] mb-[48px] text-[36px]">Hola,<br />Here comes our new merch.<br /><br />Enjoy!</h1>
